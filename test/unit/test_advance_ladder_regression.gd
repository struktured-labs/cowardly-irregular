...
## AFTER the press. Fighter STEEL + Cleric Faith tiers shipped v3.33.133 —
## the reworked fighter set replaces the parked drum-v1 pilot.

const LADDERED_JOBS := ["fighter", "cleric"]
