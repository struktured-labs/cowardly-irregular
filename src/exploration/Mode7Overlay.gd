...
var ground_y: float = 0.52  # 2026-07-14: was 0.48 — horizon 4% higher, less "extreme" sky slab (struktured playtest)
var curvature: float = 0.003  # 2026-07-14: was 0.005 — less fisheye warp; still non-zero for the SNES tilt
...
const WORLD_PRESETS: Dictionary = {
	"medieval": {
		"curvature": 0.003,  # 2026-07-14: was 0.005 — horizon-tune pass, less extreme
