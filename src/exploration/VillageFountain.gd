...
func _draw_fountain(image: Image, frame: int) -> void:
	...
	var stone_light = Color(0.80, 0.74, 0.62)
	var stone_dark = Color(0.50, 0.44, 0.36)
	var stone_shadow = Color(0.38, 0.33, 0.26)
	var water = Color(0.28, 0.50, 0.78, 0.85)
	var water_mid = Color(0.38, 0.58, 0.84, 0.88)
	var water_light = Color(0.55, 0.75, 0.96, 0.92)
	var water_deep = Color(0.18, 0.38, 0.65, 0.82)
	var water_sparkle = Color(0.90, 0.95, 1.0, 0.95)
	var trunk = Color(0.48, 0.32, 0.18)
	var trunk_light = Color(0.58, 0.42, 0.25)
	var trunk_dark = Color(0.34, 0.22, 0.10)
	var leaves = Color(0.30, 0.55, 0.28)
	var leaves_light = Color(0.45, 0.68, 0.38)
	var leaves_dark = Color(0.18, 0.42, 0.18)
	var leaves_deep = Color(0.10, 0.28, 0.12)
