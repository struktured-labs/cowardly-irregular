...
func _play_advance_sound(depth: int = 1) -> void:
	...
	# Per-job escalation ladder (struktured-approved: fighter STEEL + cleric Faith + rogue inverted + mage arcane tiers); jobs without a ladder key fall back to the arcade credit.
