...
- **Data**: 14 jobs, 288 abilities, 98 monsters (artist art for slime/bat/goblin + 5 duel minibosses T2), 172 items, 34 encounter pools, 193 cutscenes (44 party/event chats, guarded: every registry chat needs its JSON + a live emitter), music: **161 distinct OGGs**, 165 manifest entries, 163 files in `assets/audio/music/` — three different true numbers, so say which you mean. 165 counts ENTRIES and `battle_brute.ogg` is named by five keys (the monster-family ruling); 163 counts the DIRECTORY. "153 music tracks" stood here from 2026-07-30, in a commit whose own subject was "plus 10 stale counts". 259 SFX
