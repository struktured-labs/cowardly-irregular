...
MONSTER_DESC = {
    "barbarian":      "a towering HUMAN barbarian warrior — a MAN, not a monster. NOT green, NOT tusked, NOT hunched. Sun-weathered pale skin, heavy muscular bare torso and arms, long braided red-blond hair and a thick braided beard, blue woad warpaint streaked across face and chest, a fur-and-leather kilt with a wide iron-buckled belt, fur-wrapped boots, bronze arm-rings. Wields a MASSIVE DOUBLE-BLADED BATTLE AXE in a two-handed grip. Wide planted stance, head back, roaring. Human proportions — a very big man, NOT a giant and NOT an ogre",
    "ogre":           "an enormous ogre with STONE-GREY and DUN-BROWN hide — emphatically NOT green (the forest troll and cave troll are the green ones; this must not read as either). A vast sagging gut hanging over a scrap-iron belt, tiny dull piggish eyes in a small head sunk between huge sloped shoulders, two SHORT BLUNT HORNS on the brow, a heavy underbite with two chipped tusks, a yellowed bone pierced through the septum, one milky blind eye, crude riveted iron plate strapped to one shoulder and one forearm. Carries a CRUDE FOUND CLUB — an unworked tree limb, bark still on it, roots or a knot forming the head, gripped one-handed and resting on a shoulder. It did not carve this; it picked it up. NOT a forged weapon, NOT an axe, NOT a smith-made maul. Hunched, ponderous, stupidly cruel",
