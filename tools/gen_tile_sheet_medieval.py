...
def main():
    ...
    # ensure_ascii=False: the manifest holds em-dashes and emoji in its prose fields, and the
    # default escapes every one to \\uXXXX -- 135 lines of churn in a file four lanes edit.
