...
const ASKS := [
	...
	{"key": "ap_bank", "domain": "autobattle", "job": "mage",
	 "text": "only cast the big spells once i have banked up a lot of AP, and never go into debt"},
	{"key": "ap_debt", "domain": "autobattle", "job": "fighter",
	 "text": "it is fine to go deep into AP debt if the enemy is nearly dead"},
